...
mapaBackground.src = "imagenesMokepon/mokepoMap.jpg";
...
function obtenerAtaques() {
  ...
  fetch(`http://localhost:8080/mokepon/${enemigoId}/ataques`).then(
    function (res) {
      if (res.ok) {
